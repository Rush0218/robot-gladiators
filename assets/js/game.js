...
//recursive function for fight/skip prompt
...
var fight = function(enemy) {
    ...
    while(playerInfo.health > 0 && enemy.health > 0) {
       ...
       //generate random damage values based on player's health
     ...
     //switch attack order for next round
...
var startGame = function() {
    ...
    for(var i = 0; i < enemyInfo.length; i++) {
        ...
        if (playerInfo.health > 0) {
            //let player know what round they're currently in
            ...
            if (playerInfo.health > 0 && i < enemyInfo.length - 1) {
                //ask if playey wants to use the store before next round 
